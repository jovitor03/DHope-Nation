...
import Layout from "../../layouts/DonorLayout.js";
import { getCampaignImages } from "../../api/Campaign";
import LevelSystem from "../../utils/LevelSystem"; // Import LevelSystem
import { updateLevel, getDonorProfile } from "../../api/Profile"; // Import updateLevel and getUserProfile
...
function CampaignDonation() {
  ...
  const consoleLogXpOfEachLevelFrom1To100 = () => {
    for (let i = 2; i <= 100; i++) {
      console.log(`Level ${i}: ${LevelSystem.getMaxXPForLevel(i)}`);
    }
  };

  useEffect(() => {
    consoleLogXpOfEachLevelFrom1To100();
  }, []);
