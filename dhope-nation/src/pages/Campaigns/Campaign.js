...
//                   alt="Main"
//                   className="h-36 w-full 2xl:h-[191px] object-cover border-t border-black"
//                   onClick={() => handleImageClick(`http://127.0.0.1:8000${images[0].image}`)}
//                 />
//               </div>
//               <div className="flex flex-row justify-between mt-9 2xl:mt-12 z-10">
//                 {images.slice(1).map((image, index) => (
...
//             <img src={selectedImage} alt="Selected Campaign" className="max-w-full max-h-full border-2 border-white" />
//             <button className="absolute top-2 right-2 text-white text-2xl" onClick={handleCloseModal}>×</button>
//           </div>
//         </div>
//       )}
//     </Layout>
